...
<html lang="en" dir="ltr">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light">
     ...
     <div class="container">
       <h2 class="header-title mt-4">Input Data Produk</h2>
       ...
       <div class="row">
         ...
         <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-12 col-12">
           <form method="POST" action="process/insert_produk.php" class="">

               <div class="form-group">
                 <label for="">Nama Barang</label>
                 <input id="" name="nama_barang" class="w-100" type="text">
               </div>

               <div class="form-group">
                 <label for="">Quantity</label>
                 <input id="" name="quantity" class="w-100" type="number">
               </div>
